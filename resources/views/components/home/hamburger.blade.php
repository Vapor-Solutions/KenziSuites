<nav class="hamburger-navigation">
    ...
    <div class="container">
        <ul class="nav-menu mobile-menu">
            <!-- <li><a href="quardo.html">Discover Quardo</a></li>
        ...
        <div class="info-box"> <span>Follow us on Social Media</span>
            <ul class="nav-social">
                <li><a href="https://www.facebook.com/kenzisuites/"><i class="lni lni-facebook-filled"></i></a>
                </li>
                <li><a href="https://www.instagram.com/kenzi_suites/"><i class="lni lni-instagram"></i></a></li>
                <li><a href="https://www.linkedin.com/company/kenzi-suites"><i class="lni lni-linkedin"></i></a>
                </li>
            </ul>
        </div>
        <!-- end info-box -->
